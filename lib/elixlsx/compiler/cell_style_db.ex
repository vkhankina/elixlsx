  ...
  def register_style(cellstyledb, style) do
    case Map.fetch(cellstyledb.cellstyles, style) do
      :error ->
        ...
        csdb =
          update_in(cellstyledb.cellstyles, &Map.put(&1, style, cellstyledb.element_count + 1))
