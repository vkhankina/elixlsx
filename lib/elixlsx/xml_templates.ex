defmodule Elixlsx.XMLTemplates do
  ...
  """
  def docprops_app do
    U.replace_all(@docprops_app, [{"__APPVERSION__", U.app_version_string()}])
  end
    ...
    |> Enum.map(fn {cell, colidx} ->
      ...
      if is_nil(content) do
        ...
        case content_type do
          :formula ->
            value =
              if not is_nil(content_opts[:value]), do: "<v>#{content_opts[:value]}</v>", else: ""
